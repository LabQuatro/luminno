        ...
        {projects.map((item, i) => {
          ...
          return (
            <div className="lg:col-6" key={`item-${i}`}>
              <div
                className={`flex items-center space-x-4 rounded-lg bg-white px-6 py-8 shadow-lg lg:mt-6  ${
                  projects.length - 1 === i ? "mb-0" : "mb-6 "
                } `}
              >
                <div className="relative inline-flex h-24 w-24 items-center justify-center p-3">
                  <span className="project-icon text-[#fa9d11]">
                    {" "}
                ...
                <div>
                  ...
                  <p className="font-primary text-black">{item.tagline}</p>
